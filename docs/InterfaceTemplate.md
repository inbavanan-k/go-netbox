...
**Type** | [**InterfaceTemplateType**](InterfaceTemplateType.md) |  | 
...
`func NewInterfaceTemplate(id int32, url string, display string, name string, type_ InterfaceTemplateType, ) *InterfaceTemplate`
...
`func (o *InterfaceTemplate) GetType() InterfaceTemplateType`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InterfaceTemplate) GetTypeOk() (*InterfaceTemplateType, bool)`
...
`func (o *InterfaceTemplate) SetType(v InterfaceTemplateType)`
